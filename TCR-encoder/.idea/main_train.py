...
def get_dict(datafile):
    ...
    src_dict = {}
    with open("/project/transformer/SimCLR-master/data/pretrain/data/" + datafile + "_dict.txt", 'r') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', default=0, type=int, help='Number of sweeps over the dataset to train')
